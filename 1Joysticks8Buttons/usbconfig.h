 ...
 */
#define USB_CFG_VENDOR_NAME 'v','u','s','b','.','w','i','k','i','d','o','t','.','c','o','m','/','p','r','o','j','e','c','t',':','m','a','m','e','p','a','n','e','l'
...
#   define USB_CFG_DEVICE_NAME 'V','-','U','S','B',' ','M','a','m','e',' ','P','a','n','e','l', ' ', '8'
#   define USB_CFG_DEVICE_NAME_LEN 18
#elif defined __AVR_ATmega32__
#   define USB_CFG_DEVICE_NAME 'V','-','U','S','B',' ','M','a','m','e',' ','P','a','n','e','l', ' ', '3', '2'
